...
const PORTFOLIO_INTEREST_OPTIONS = [
  'Journalism / Writing',
...
const PRIOR_BACKGROUND_OPTIONS = [
...
const PORTFOLIO_PROJECT_SCHEMA = {
  program: 'portfolio-project',
  title: 'Portfolio Project - Application',
  shortTitle: 'PORT',
  steps: [
    {
      id: 'basic',
      title: 'Basic info',
      description: 'Tell us a bit about yourself so we can get in touch.',
      fields: SHARED_BASIC_FIELDS.map((field) => {
        if (field.id === 'messaging_platform') {
          return {
            ...field,
            helper:
              'Please share your preferred way to coordinate and receive updates (e.g. WhatsApp number, WeChat ID, Line, or another handle). Type "N/A" if you prefer email only.',
          }
        }
        if (field.id === 'citizenship') {
          return {
            ...field,
            label: 'Which country/countries are you a citizen of?',
          }
        }
        if (field.id === 'timezone') {
          return {
            ...field,
            helper: 'E.g. EST (Eastern Standard Time), PST (Pacific Standard Time), etc.',
          }
        }
        return field
      }),
    },
    {
      ...
      description: 'Help us understand the kind of work you want to make.',
      fields: [
        {
          id: 'target_major',
          label: 'What is your target college application major or field?',
        ...
        },
        {
          ...
          helper:
            'Select all that apply - our team will match you with a mentor whose expertise aligns with your interests.',
          type: 'checkbox',
          required: false,
          options: PORTFOLIO_INTEREST_OPTIONS,
        },
        {
          id: 'specific_interest_direction',
          label:
            "Tell us more about your specific area of interest and what you'd like to create or build.",
          helper:
            'If you have a particular direction in mind, share it here. The more specific you are, the better we can match you.',
          type: 'textarea',
          required: true,
        },
        {
          id: 'why_interested',
          label:
            'Why are you interested in this area? Tell us about any relevant experience, projects, or things you have made.',
          helper:
            'Please describe any relevant coursework, projects, or experiences related to these fields. 200 words or fewer.',
          type: 'textarea',
          required: true,
        },
      ],
    },
    {
      id: 'background',
      title: 'Background & commitment',
      description: 'Tell us how you are starting and what pace you can sustain.',
      fields: [
        {
          id: 'prior_background',
          label: 'Do you have any prior background in your area of interest?',
          type: 'radio',
          required: false,
          options: PRIOR_BACKGROUND_OPTIONS,
        },
        {
          id: 'time_commitment',
          label:
            'How much time can you realistically commit to this project outside of your class sessions each week?',
          type: 'radio',
          required: false,
        ...
        },
        {
          id: 'project_goal',
          label:
            'What are you hoping to get out of this project? (e.g. build a portfolio piece for applications, explore a new field, develop a specific skill)',
          type: 'textarea',
          required: true,
        },
      ],
    ...
    {
      id: 'track',
      title: 'Track & mentor fit',
      description: 'Help us place you on the right track and mentor style.',
      fields: [
        {
          id: 'portfolio_track',
          label: 'Which track are you applying for?',
          helper:
            "Track 1 is for students who want to explore and build a first piece. Track 2 is for students with a clear direction who need a portfolio-ready piece for their college applications.",
          type: 'radio',
          required: true,
          options: [
            'Track 1 - Explore & Create (I want to try this out, develop my skills, and produce a first piece of work.)',
            'Track 2 - Portfolio Ready (I have a clear direction and want to build a polished, application-ready piece for my college portfolio.)',
            "Not sure yet - help me decide (I'd like guidance on which track fits my goals.)",
          ],
        },
        {
          id: 'preferred_mentor',
          label:
            "Is there a particular industry, mentor background, or working style you'd prefer?",
          helper:
            'For example: someone who works at a specific type of company or studio, a mentor whose work focuses on a particular area within the field, or a working style that suits you best (e.g. structured step-by-step guidance vs. more room to experiment and explore). We will do our best to accommodate your preferences, though placement depends on mentor availability.',
          type: 'textarea',
          required: false,
        },
      ],
    },
    {
      ...
      fields: [
        {
          id: 'parent_name',
          label: "What is your parent or guardian's full name?",
          helper:
            'As our program involves minors, we require one parent or guardian contact for enrollment and communication purposes.',
          type: 'text',
          required: true,
        },
        {
          ...
          helper:
            'We may reach out to parents or guardians for enrollment confirmation and program updates. Please double-check for accuracy.',
          type: 'text',
          required: true,
        },
        {
          ...
          helper: 'Please insert any special requests here.',
          type: 'textarea',
          required: false,
        },
      ],
...
export const FORM_SCHEMAS = {
  ...
  'portfolio-project': PORTFOLIO_PROJECT_SCHEMA,
}
