...
export default function CourseHours({ applicationId }) {
  ...
  useEffect(() => {
    ...
    async function load() {
      const enrollmentResult = await supabase
        ...
        .select('*, course_plans(id, name, description)')
  ...
  return (
    <section className={styles.studentCard}>
      ...
      <div className={styles.progressCaption}><span>{Math.round(percentage)}% used</span><span>Started {enrollment.started_at}</span></div>
